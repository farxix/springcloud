...
import com.router.api.utils.OpResultUtils;
 ...
 *
 * @author Jacob Liu <Liuxy8@asiainfo.com> 2018/1/10 15:47
 */
public class JsonResponse implements Serializable, Cloneable {
	...
	public String toString() {
		return new ToStringBuilder(this).append("id", id).append("status", status).append("message", message)
