...
import com.common.api.JsonResponse;
...
public class CommonUtils {
     ...
     * </pre>
     * <p>调用：<br/></p>
     * ResponseFields responseFields = (ResponseFields) CommonUtil.extractValueAsObject(data, "response", ResponseFields.class);
     *
     ...
     * </pre>
     * <p>调用：<br/></p>
     * List&lt;ExampleUserData&gt; list = CommonUtil.extractValueAsList(data, "list", ExampleUserData.class);
     *
     * @param data         data 节点对象
     * @param propertyName data 节点的属性名称
     * @param clazz        对象类名
